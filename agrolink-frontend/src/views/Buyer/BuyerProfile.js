...
import { obtenerPerfil, actualizarDatosPersonales, actualizarPerfilComercial, cambiarPassword } from '../../api/compradorService';
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '30px' }}>
                ...
                <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: 'var(--radius-lg)', boxShadow: '0 4px 10px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <form onSubmit={handleProfileSubmit} style={{ flex: 1 }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                            <div><label style={{ display: 'block', marginBottom: '8px', fontWeight: '500' }}>Nombre</label><input type="text" name="nombres" required value={profileData.nombres || ''} onChange={handleProfileChange} style={inputStyle} /></div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                            <div>
                                ...
                                <input type="email" disabled value={profileData.email || ''} style={{ ...inputStyle, backgroundColor: '#f5f5f5', color: '#777', cursor: 'not-allowed' }} />
                            </div>
                        </div>
                ...
                <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: 'var(--radius-lg)', boxShadow: '0 4px 10px rgba(0,0,0,0.05)' }}>
                    ...
                    <form onSubmit={handlePerfilComercialSubmit}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                            <div><label style={{ display: 'block', marginBottom: '8px', fontWeight: '500' }}>RUC / DNI</label><input type="text" name="dniRuc" value={profileData.dniRuc || ''} onChange={handleProfileChange} style={inputStyle} /></div>
