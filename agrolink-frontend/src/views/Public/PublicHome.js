...
function PublicHome() {
  ...
  const filteredCrops = catalog.filter((crop) => {
    ...
    const matchesCertifications =
      ...
      selectedCertifications.every(
        (cert) => crop.certificaciones && crop.certificaciones.includes(cert),
      );
  ...
  const handleAddToCart = () => {
    ...
    if (
      !purchaseData.direccionEntrega ||
      !purchaseData.direccionEntrega.trim()
    ) {
    ...
    const getNextPartialSuffix = (loteCentral) => {
      const savedOrders = JSON.parse(
        localStorage.getItem("agrolink_orders") || "[]",
      );
      let count = 0;
      ...
      const savedCart = JSON.parse(
        localStorage.getItem("agrolink_cart") || "[]",
      );
    ...
    const generatedLoteParcial = getNextPartialSuffix(
      selectedCrop.lote || "LOTE",
    );
    ...
    alert(
      `¡${selectedCrop.nombre} añadido al carrito con éxito!\n\nLote Parcial Generado: ${generatedLoteParcial}`,
    );
  ...
  const cartAdelanto = cartItems.reduce(
    (acc, curr) => acc + curr.montoTotal * (curr.porcentajeAdelanto / 100),
    0,
  );
  ...
  const handleCheckout = () => {
    ...
    if (!isAuthenticated) {
      alert(
        "Para proceder al pago de tu preventa asegurada, necesitas iniciar sesión o registrarte.",
      );
      setIsCartOpen(false);
      navigate("/login");
      ...
      alert(
        "Has iniciado sesión como Agricultor. Para comprar, necesitas una cuenta de perfil Comprador.",
      );
      setIsCartOpen(false);
    }
  };
    ...
    >
      ...
      <header
        ...
        style={{
          ...
          textAlign: "center",
          background:
            "linear-gradient(rgba(46, 125, 50, 0.9), rgba(27, 94, 32, 0.95)), url(https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80) no-repeat center/cover",
      ...
      >
        {/* SIDEBAR */}
        <aside
          className={`sidebar-panel ${isFiltersOpen ? "open" : ""}`}
          style={{
            width: "320px",
                      ...
                      <div>
                        ...
                        >
                          ...
                          <span style={{ fontSize: "0.8rem", color: "#666" }}>
                            Var: <strong>{crop.variedad}</strong>
                          </span>
                        </div>
                        <h3
                          style={{
                        ...
                        {crop.certificaciones &&
                          crop.certificaciones.length > 0 && (
                            <div
                              style={{
                                display: "flex",
                                gap: "5px",
                        ...
                        <button
                          onClick={() => {
                            ...
                            setPurchaseData((prev) => ({
                              ...prev,
                              direccionEntrega: getProfileAddress(),
                            }));
                          }}
                          style={{
                            width: "100%",
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    color:
                      currentPage === totalPages ? "#aaa" : "var(--color-text)",
                    fontWeight: "bold",
                    cursor:
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  {selectedCrop.nombre} - {selectedCrop.variedad}
                </h3>
                <p style={{ margin: "0 0 5px 0", color: "#555" }}>
                  Agricultor: <strong>{selectedCrop.agricultor}</strong>
                </p>
                <span
                  style={{
                    display: "flex",
                ...
                >
                  {selectedCrop.certificaciones &&
                    selectedCrop.certificaciones.map((cert, idx) => (
                      <span
                        key={idx}
                        style={{
                          backgroundColor: "#E8F5E9",
            ...
            >
              <div>
                ...
                >
                  S/ {parseFloat(selectedCrop.precio).toFixed(2)}
                </strong>
              </div>
              <div>
                <span
                ...
                >
                  Total Lote Declarado
                </span>
                <strong
                  style={{ fontSize: "1.1rem", color: "var(--color-text)" }}
                >
                  {selectedCrop.cantidadTotal}
                </strong>
              </div>
              <div>
                <span
                ...
                >
                  ...
                  {selectedCrop.fechaSiembra && (
                    <div>
                      ...
                      >
                        {new Date(selectedCrop.fechaSiembra).toLocaleDateString(
                          "es-PE",
                        )}
                      </span>
                    </div>
                  ...
                  <div>
                    ...
                    >
                      {selectedCrop.variedad || "Estándar"}
                    </span>
                  </div>
                </div>

                {selectedCrop.etapas &&
                  Object.keys(selectedCrop.etapas).length > 0 && (
                    <div style={{ marginTop: "15px" }}>
                      ...
                      >
                        Progreso de Etapas del Cultivo
                      </span>
                      <div
                        style={{
                          display: "flex",
                      ...
                      >
                        {Object.entries(selectedCrop.etapas).map(
                          ([etapa, pct]) => (
                            <div
                              key={etapa}
                              style={{
            ...
            >
              Configurar Compra de la Preventa
            </h4>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setPurchaseData({ ...purchaseData, cantidad: e.target.value })
                }
                style={{
                  width: "100%",
                  padding: "12px",
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              >
                Dirección de Entrega para este Producto
              </label>
              <input
                type="text"
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              >
                Opcional. Si se deja vacío se calculará automáticamente (90
                días).
              </span>
            </div>
            ...
            >
              <div>
                ...
                >
                  ...
                  <option value="Crédito Comercial 30 días">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setPurchaseData({
                      ...purchaseData,
                      porcentajeAdelanto: parseInt(e.target.value) || 0,
                    })
                  }
                  style={{
                    width: "100%",
                ...
                >
                  <option value={0}>
                    Sin Adelanto (Pago 100% al entregar)
                  </option>
                  <option value={30}>30% Adelanto (Garantía estándar)</option>
                  <option value={50}>
                    50% Adelanto (Garantía prioritaria)
                  </option>
                </select>
              </div>
            </div>
            ...
            {purchaseData.cantidad > 0 && (
              ...
              >
                ...
                >
                  Resumen Estimado de la Preventa
                </h4>
                <p style={{ margin: "0 0 8px 0" }}>
                  ...
                  <strong style={{ fontSize: "1.1rem" }}>
                    S/{" "}
                    {(
                      parseFloat(purchaseData.cantidad) *
                      parseFloat(selectedCrop.precio)
                    ).toFixed(2)}
                  </strong>
                </p>
                <p style={{ margin: "0 0 8px 0", color: "#2E7D32" }}>
                  Adelanto a pagar ahora ({purchaseData.porcentajeAdelanto}%):{" "}
                  <strong>
                    S/{" "}
                    {(
                      parseFloat(purchaseData.cantidad) *
                      parseFloat(selectedCrop.precio) *
                      (purchaseData.porcentajeAdelanto / 100)
                    ).toFixed(2)}
                  </strong>
                </p>
                <p style={{ margin: 0, color: "#d32f2f" }}>
                  Contraentrega ({100 - purchaseData.porcentajeAdelanto}%):{" "}
                  <strong>
                    S/{" "}
                    {(
                      parseFloat(purchaseData.cantidad) *
                      parseFloat(selectedCrop.precio) *
                      ((100 - purchaseData.porcentajeAdelanto) / 100)
                    ).toFixed(2)}
                  </strong>
                </p>
              </div>
              ...
              {cartItems.length === 0 ? (
                <div style={{ textAlign: "center", padding: "40px 20px" }}>
                  ...
                  <p style={{ color: "#888", fontSize: "1rem" }}>
                    Tu carrito está vacío. ¡Explora el catálogo y añade
                    productos!
                  </p>
                </div>
              ) : (
          ...
          >
            ...
            {companyModal === "about" && (
              <>
                ...
                >
                  AgroLink es una plataforma diseñada para digitalizar la cadena
                  de suministro agropecuaria en América Latina. A través de
                  preventas garantizadas y trazabilidad completa del cultivo,
                  mitigamos el riesgo financiero tanto para el agricultor como
                  para el comprador.
                </p>
                <p
                  style={{
                ...
                >
                  Buscamos eliminar los intermediarios innecesarios en la
                  distribución agrícola, permitiendo que las ganancias se
                  distribuyan de manera más justa y que los alimentos lleguen
                  más frescos y seguros a los centros de consumo.
                </p>
              </>
            )}
            ...
            {companyModal === "mission" && (
              <>
                ...
                >
                  Conectar eficientemente el campo con el mercado mediante
                  tecnología innovadora, garantizando transparencia,
                  trazabilidad y comercio justo. Buscamos empoderar al
                  agricultor asegurando su venta desde el momento de la siembra,
                  y brindar seguridad de abastecimiento y precios estables al
                  comprador.
                </p>
              </>
            )}
            ...
            {companyModal === "vision" && (
              <>
                ...
                >
                  Ser la plataforma tecnológica líder en Latinoamérica en la
                  digitalización de pre-compras agrícolas, revolucionando la
                  cadena de suministro global y construyendo un modelo de
                  soberanía alimentaria sostenible, transparente y equitativo
                  para el siglo XXI.
                </p>
              </>
            )}
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              >
                Agro
                <span style={{ color: "var(--color-secondary)" }}>Link</span>
              </h3>
            </div>
            <p
              style={{
            ...
            >
              Digitalizando el agro comercio en Latinoamérica mediante preventas
              y trazabilidad de cultivos en tiempo real.
            </p>
          </div>
        ...
        >
          &copy; {new Date().getFullYear()} AgroLink Inc. Todos los derechos
          reservados. Digitalización del campo con transparencia.
        </div>
      </footer>
    </div>
  );
